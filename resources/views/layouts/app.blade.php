...
<head>
    ...
    <!-- Page Title  -->
    <title>Myxclusive</title>
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="{{ asset('src/assets/css/dashlite.css') }}">
    <link id="skin-default" rel="stylesheet" href="{{ asset('src/assets/css/theme.css') }}">
</head>
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="html/index.html" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" src="{{ asset('src/images/logo.png') }}"
                                srcset="{{ asset('src/images/logo2x.png 2x') }}" alt="logo">
                            <img class="logo-dark logo-img" src="{{ asset('src/images/logo-dark.png') }}"
                                srcset="{{ asset('src/images/logo-dark2x.png 2x') }}" alt="logo-dark">
                            <img class="logo-small logo-img logo-img-small"
                                src="{{ asset('src/images/logo-small.png') }}"
                                srcset="{{ asset('src/images/logo-small2x.png 2x') }}" alt="logo-small">
                        </a>
                    </div>
    ...
    <!-- app-root @e -->
    <!-- JavaScript -->
    <script src="{{ asset('src/assets/js/bundle.js?ver=2.4.0') }}"></script>
    <script src="{{ asset('src/assets/js/scripts.js?ver=2.4.0') }}"></script>
</body>
