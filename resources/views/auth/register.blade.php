                    ...
                    <div class="nk-block nk-block-middle nk-auth-body wide-xs">
                        ...
                        <div class="card">
                            <div class="card-inner card-inner-lg">
                                ...
                                <div class="form-note-s2 text-center pt-4">¿Ya tienes una cuenta?<a
                                        href="html/pages/auths/auth-login-v2.html"><strong> Inicia Sesión</strong></a>
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="nk-block-content text-center text-lg-left">
                                        <p class="text-soft">&copy; 2021 MyXclusive. Todos los derechos reservados.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
